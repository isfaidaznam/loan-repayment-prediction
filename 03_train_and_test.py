...
def train_neural_network(train_df):
    ...
    X_train, X_val, y_train, y_val = train_test_split(X, y, test_size=0.2, shuffle=Config().ML_TRAINING['RANDOMNESS'], random_state=42)
...
if __name__=="__main__":
    try:
        ...
        model = train_neural_network(train_df)
